...
torso_t0 (base) 	{  joint:hingeX, limits:[-1.3963, 1.3963, 10000, 50000, 1] , ctrl_limits:[10000, 50000, 1] }
...
torso_1 (torso_t0) 	{  shape:mesh, color:[0.2, 0.2, 0.2, 1], mesh:'torso/base_link-simple.STL',, colorName:darkgray, visual }
torso_0 (torso_t0) 	{  shape:mesh, color:[0.8, 0.2,0.2, 1], mesh:'torso/base_link_collision-simple.STL', contact:-2, }
...
collision_head_link_1_1 (collision_head_1) 	{  shape:sphere, size:[0, 0, 0, 0.001], color:[0.85, 0.2, 0.2, 1],, colorName:red, visual }
collision_head_link_1_0 (collision_head_1) 	{  shape:sphere, size:[0, 0, 0, 0.22], color:[0.8, 0.2,0.2, 1], contact:-2, }
collision_head_link_2 (collision_head_2) 	{ , mass:0.0001, inertiaTensor:[1e-08, 0, 0, 1e-08, 0, 1e-08] }
collision_head_link_2_1 (collision_head_2) 	{  shape:sphere, size:[0, 0, 0, 0.001], color:[0.85, 0.2, 0.2, 1],, colorName:red, visual }
collision_head_link_2_0 (collision_head_2) 	{  shape:sphere, size:[0, 0, 0, 0.22], color:[0.8, 0.2,0.2, 1], contact:-2, }
...
head_pan (torso>head_pan) 	{  joint:hingeX, limits:[-1.3963, 1.3963, 10000, 50000, 1] , ctrl_limits:[10000, 50000, 1] }
...
pedestal_1 (pedestal_fixed) 	{  shape:mesh, color:[0.2, 0.2, 0.2, 1], mesh:'base/PEDESTAL.ply',, colorName:darkgray, visual }
pedestal_0 (pedestal_fixed) 	{  shape:mesh, color:[0.8, 0.2,0.2, 1], mesh:'base/pedestal_link_collision.ply', contact:-2, }
...
head_1 (head_pan) 	{  shape:mesh, color:[0.2, 0.2, 0.2, 1], mesh:'head/H0-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkgray, visual }
head_0 (head_pan) 	{  shape:sphere, size:[0, 0, 0, 0.001], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
sonar_ring_1 (sonar_s0) 	{  shape:cylinder, size:[0, 0, 0.01, 0.085], color:[0.2, 0.2, 0.2, 1], Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkgray, visual }
sonar_ring_0 (sonar_s0) 	{  shape:sphere, size:[0, 0, 0, 0.001], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
head_nod (head>head_nod) 	{  joint:hingeX, limits:[-1.3963, 1.3963, 10000, 50000, 1] , ctrl_limits:[10000, 50000, 1] }
head_camera (head>head_camera) 	{  joint:rigid  }
right_s0 (right_arm_mount>right_s0) 	{  joint:hingeX, limits:[-1.70168, 1.70168, 1.5, 50, 1] , ctrl_limits:[1.5, 50, 1] }
left_s0 (left_arm_mount>left_s0) 	{  joint:hingeX, limits:[-1.70168, 1.70168, 1.5, 50, 1] , ctrl_limits:[1.5, 50, 1] }
...
screen_1 (head_nod) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'head/H1-simple.STL',, colorName:darkred, visual }
screen_0 (head_nod) 	{  shape:sphere, size:[0, 0, 0, 0.001], color:[0.8, 0.2,0.2, 1], contact:-2, }
screen>display_joint (head_nod) 	{  Q:<[0, -0.016, 0, 1, 0, 0, 0]> }
screen>head_kinect (head_nod) 	{  Q:<[0.073, 0.075, 0.014, 0.0456854, 0.0205805, -0.409754, 0.910819]> }
...
right_upper_shoulder_1 (right_s0) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'upper_shoulder/S0-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
right_upper_shoulder_0 (right_s0) 	{  shape:cylinder, size:[0, 0, 0.2722, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_upper_shoulder_1 (left_s0) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'upper_shoulder/S0-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
left_upper_shoulder_0 (left_s0) 	{  shape:cylinder, size:[0, 0, 0.2722, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
head_kinect (screen>head_kinect) 	{  joint:rigid  }
right_s1 (right_upper_shoulder>right_s1) 	{  joint:hingeX, limits:[-2.147, 1.047, 1.5, 50, 1] , ctrl_limits:[1.5, 50, 1] }
left_s1 (left_upper_shoulder>left_s1) 	{  joint:hingeX, limits:[-2.147, 1.047, 1.5, 50, 1] , ctrl_limits:[1.5, 50, 1] }
display (display_joint) 	{ , mass:0.0001, inertiaTensor:[1e-08, 0, 0, 1e-08, 0, 1e-08] }
display_1 (display_joint) 	{  shape:box, size:[0.218, 0.16, 0.001, 0], color:[0, 0, 0, 1],, colorName:black, visual }
camera_rgb_optical_frame (head_kinect) 	{ , mass:0.0001, inertiaTensor:[1e-08, 0, 0, 1e-08, 0, 1e-08] }
...
right_lower_shoulder_1 (right_s1) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'lower_shoulder/S1-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
right_lower_shoulder_0 (right_s1) 	{  shape:cylinder, size:[0, 0, 0.12, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_lower_shoulder_1 (left_s1) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'lower_shoulder/S1-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
left_lower_shoulder_0 (left_s1) 	{  shape:cylinder, size:[0, 0, 0.12, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
right_e0 (right_lower_shoulder>right_e0) 	{  joint:hingeX, limits:[-3.05418, 3.05418, 1.5, 50, 1] , ctrl_limits:[1.5, 50, 1] }
right_e0_fixed (right_lower_shoulder>right_e0_fixed) 	{  joint:rigid  }
left_e0 (left_lower_shoulder>left_e0) 	{  joint:hingeX, limits:[-3.05418, 3.05418, 1.5, 50, 1] , ctrl_limits:[1.5, 50, 1] }
...
right_upper_elbow_1 (right_e0) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'upper_elbow/E0-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
right_upper_elbow_0 (right_e0) 	{  shape:cylinder, size:[0, 0, 0.107, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
right_upper_elbow_visual_0 (right_e0_fixed) 	{  shape:cylinder, size:[0, 0, 0.273, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_upper_elbow_1 (left_e0) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'upper_elbow/E0-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
left_upper_elbow_0 (left_e0) 	{  shape:cylinder, size:[0, 0, 0.107, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_upper_elbow_visual_0 (left_e0_fixed) 	{  shape:cylinder, size:[0, 0, 0.273, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
right_e1 (right_upper_elbow>right_e1) 	{  joint:hingeX, limits:[-0.05, 2.618, 1.5, 50, 1] , ctrl_limits:[1.5, 50, 1] }
left_e1 (left_upper_elbow>left_e1) 	{  joint:hingeX, limits:[-0.05, 2.618, 1.5, 50, 1] , ctrl_limits:[1.5, 50, 1] }
...
right_lower_elbow_1 (right_e1) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'lower_elbow/E1-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
right_lower_elbow_0 (right_e1) 	{  shape:cylinder, size:[0, 0, 0.1, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_lower_elbow_1 (left_e1) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'lower_elbow/E1-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
left_lower_elbow_0 (left_e1) 	{  shape:cylinder, size:[0, 0, 0.1, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
right_w0 (right_lower_elbow>right_w0) 	{  joint:hingeX, limits:[-3.059, 3.059, 4, 15, 1] , ctrl_limits:[4, 15, 1] }
right_w0_fixed (right_lower_elbow>right_w0_fixed) 	{  joint:rigid  }
left_w0 (left_lower_elbow>left_w0) 	{  joint:hingeX, limits:[-3.059, 3.059, 4, 15, 1] , ctrl_limits:[4, 15, 1] }
...
right_upper_forearm_1 (right_w0) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'upper_forearm/W0-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
right_upper_forearm_0 (right_w0) 	{  shape:cylinder, size:[0, 0, 0.088, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
right_upper_forearm_visual_0 (right_w0_fixed) 	{  shape:cylinder, size:[0, 0, 0.272, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_upper_forearm_1 (left_w0) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'upper_forearm/W0-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
left_upper_forearm_0 (left_w0) 	{  shape:cylinder, size:[0, 0, 0.088, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_upper_forearm_visual_0 (left_w0_fixed) 	{  shape:cylinder, size:[0, 0, 0.272, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
right_w0_to_itb_fixed (right_upper_forearm>right_w0_to_itb_fixed) 	{  joint:rigid  }
right_w1 (right_upper_forearm>right_w1) 	{  joint:hingeX, limits:[-1.5708, 2.094, 4, 15, 1] , ctrl_limits:[4, 15, 1] }
left_w0_to_itb_fixed (left_upper_forearm>left_w0_to_itb_fixed) 	{  joint:rigid  }
left_w1 (left_upper_forearm>left_w1) 	{  joint:hingeX, limits:[-1.5708, 2.094, 4, 15, 1] , ctrl_limits:[4, 15, 1] }
...
right_lower_forearm_1 (right_w1) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'lower_forearm/W1-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
right_lower_forearm_0 (right_w1) 	{  shape:cylinder, size:[0, 0, 0.1, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_lower_forearm_1 (left_w1) 	{  shape:mesh, color:[0.85, 0.2, 0.2, 1], mesh:'lower_forearm/W1-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:darkred, visual }
left_lower_forearm_0 (left_w1) 	{  shape:cylinder, size:[0, 0, 0.1, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
left_lower_forearm>left_w2 (left_w1) 	{  Q:<[2.57516e-17, -0, -0.115975, -0.5, -0.5, -0.5, 0.5]> }
right_w2 (right_lower_forearm>right_w2) 	{  joint:hingeX, limits:[-3.059, 3.059, 4, 15, 1] , ctrl_limits:[4, 15, 1] }
left_w2 (left_lower_forearm>left_w2) 	{  joint:hingeX, limits:[-3.059, 3.059, 4, 15, 1] , ctrl_limits:[4, 15, 1] }
...
right_wrist_1 (right_w2) 	{  shape:mesh, color:[0.333, 0.333, 0.333, 1], mesh:'wrist/W2-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:lightgrey, visual }
right_wrist_0 (right_w2) 	{  shape:cylinder, size:[0, 0, 0.165, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_wrist_1 (left_w2) 	{  shape:mesh, color:[0.333, 0.333, 0.333, 1], mesh:'wrist/W2-simple.STL', Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]>, colorName:lightgrey, visual }
left_wrist_0 (left_w2) 	{  shape:cylinder, size:[0, 0, 0.165, 0.06], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
right_hand_0 (right_hand) 	{  shape:cylinder, size:[0, 0, 0.0464, 0.04], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_hand_0 (left_hand) 	{  shape:cylinder, size:[0, 0, 0.0464, 0.04], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, -0.707107, 0]> }
...
left_gripper_base (left_hand) 	{  joint:rigid  }
...
right_hand_camera_1 (right_hand_camera) 	{  shape:cylinder, size:[0, 0, 0.01, 0.02], color:[0.85, 0.2, 0.2, 1],, colorName:blue, visual }
...
right_hand_range_1 (right_hand_range) 	{  shape:box, size:[0.005, 0.02, 0.005, 0], color:[0.85, 0.2, 0.2, 1],, colorName:blue, visual }
right_hand_accelerometer (right_hand_accelerometer) 	{ , mass:0.0001, inertiaTensor:[1e-08, 0, 0, 1e-08, 0, 1e-08] }
right_hand_accelerometer_1 (right_hand_accelerometer) 	{  shape:box, size:[0.01, 0.01, 0.01, 0], color:[0.85, 0.2, 0.2, 1],, colorName:black, visual }
right_gripper_base (right_gripper_base) 	{ , mass:0.3, inertiaTensor:[2e-08, 0, 0, 3e-08, 0, 2e-08] }
right_gripper_base_1 (right_gripper_base) 	{  shape:mesh, mesh:'electric_gripper/electric_gripper_base.ply',, color:[0.333, 0.333, 0.333, 1], visual }
right_gripper_base_0 (right_gripper_base) 	{  shape:cylinder, size:[0, 0, 0.1, 0.029], color:[0.8, 0.2,0.2, 1], contact:-2,, colorName:darkred }
right_gripper_base>right_endpoint (right_gripper_base) 	{  Q:<[0, 0, 0.1327, 1, 0, 0, 0]> }
right_gripper_base>r_gripper_l_finger_joint (right_gripper_base) 	{  Q:<[0, 0.03, 0.02, 0.707107, 0, 0, 0.707107]> }
right_gripper_base>r_gripper_r_finger_joint (right_gripper_base) 	{  Q:<[0, -0.03, 0.02, 0.707107, 0, 0, 0.707107]> }
left_gripper_base (left_gripper_base) 	{ , mass:0.3, inertiaTensor:[2e-08, 0, 0, 3e-08, 0, 2e-08] }
left_gripper_base_1 (left_gripper_base) 	{  shape:mesh, mesh:'pneumatic_gripper/pneumatic_gripper_w_cup.ply',, color:[0.333, 0.333, 0.333, 1], visual }
left_gripper_base_0 (left_gripper_base) 	{  shape:cylinder, size:[0, 0, 0.08, 0.02], color:[0.8, 0.2,0.2, 1], contact:-2,, colorName:darkred }
...
left_hand_camera_1 (left_hand_camera) 	{  shape:cylinder, size:[0, 0, 0.01, 0.02], color:[0.85, 0.2, 0.2, 1],, colorName:blue, visual }
...
left_hand_range_1 (left_hand_range) 	{  shape:box, size:[0.005, 0.02, 0.005, 0], color:[0.85, 0.2, 0.2, 1],, colorName:blue, visual }
left_hand_accelerometer (left_hand_accelerometer) 	{ , mass:0.0001, inertiaTensor:[1e-08, 0, 0, 1e-08, 0, 1e-08] }
left_hand_accelerometer_1 (left_hand_accelerometer) 	{  shape:box, size:[0.01, 0.01, 0.01, 0], color:[0.85, 0.2, 0.2, 1],, colorName:black, visual }
right_endpoint (right_gripper_base>right_endpoint) 	{  joint:rigid  }
r_gripper_l_finger_joint (right_gripper_base>r_gripper_l_finger_joint) 	{  joint:rigid, limits:[0, 0.020833] , ctrl_limits:[5, 20, 1] }
r_gripper_r_finger_joint (right_gripper_base>r_gripper_r_finger_joint) 	{  joint:rigid, limits:[-0.020833, 0], mimic:(r_gripper_l_finger_joint) , ctrl_limits:[5, 20, 1] }
...
r_gripper_l_finger_1 (r_gripper_l_finger_joint) 	{  shape:mesh, mesh:'electric_gripper/fingers/extended_narrow.ply', Q:<[-0, -0, -0, -0.707107, 0, 0, 0.707107]>, visual }
r_gripper_l_finger_0 (r_gripper_l_finger_joint) 	{  shape:box, size:[0.01, 0.0135, 0.1127, 0], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, 0, 0.707107]> }
r_gripper_l_finger_0 (r_gripper_l_finger_joint) 	{  shape:box, size:[0.01, 0.05, 0.017, 0], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, 0, 0.707107]> }
...
r_gripper_r_finger_1 (r_gripper_r_finger_joint) 	{  shape:mesh, mesh:'electric_gripper/fingers/extended_narrow.ply', Q:<[-0, -0, -0, -0.707107, 0, 0, 0.707107]>, visual }
r_gripper_r_finger_0 (r_gripper_r_finger_joint) 	{  shape:box, size:[0.01, 0.0135, 0.1127, 0], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, 0, 0.707107]> }
r_gripper_r_finger_0 (r_gripper_r_finger_joint) 	{  shape:box, size:[0.01, 0.05, 0.017, 0], color:[0.8, 0.2,0.2, 1], contact:-2, Q:<[-0, -0, -0, -0.707107, 0, 0, 0.707107]> }
...
r_gripper_l_finger_tip_1 (r_gripper_l_finger_tip_joint) 	{  shape:mesh, mesh:'electric_gripper/fingers/half_round_tip.ply',, visual }
r_gripper_l_finger_tip_0 (r_gripper_l_finger_tip_joint) 	{  shape:cylinder, size:[0, 0, 0.037, 0.008], color:[0.8, 0.2,0.2, 1], contact:-2, }
r_gripper_r_finger_tip (r_gripper_r_finger_tip_joint) 	{ , mass:0.01, inertiaTensor:[0.01, 0, 0, 0.01, 0, 0.01] }
r_gripper_r_finger_tip_1 (r_gripper_r_finger_tip_joint) 	{  shape:mesh, mesh:'electric_gripper/fingers/half_round_tip.ply',, visual }
r_gripper_r_finger_tip_0 (r_gripper_r_finger_tip_joint) 	{  shape:cylinder, size:[0, 0, 0.037, 0.008], color:[0.8, 0.2,0.2, 1], contact:-2, }
