Include = 'baxter_clean_kinect.g'
#Include = 'baxter_clean2.g'
#Include = 'baxter_clean3.g' # with pneumatic ee
...
# Added for camera_frame
#screen>head_kinect (head_nod)   {  Q:<t(0.073 0.075 0.014) E(-0.843 -0.075 3.075)> }
